...
export class ProjectsService {
  ...
  projects: Project[] = [
    ...
    { id:2,name: 'Smart Knife Station',summary: 'Novelty application developed using python and google AI speech recognition to pick perfect type of cutlery for different applications',description: 'This project is a knife block that uses the google speech recognition API in order to listen to commands and maps it to the best cutlery item for that particular task. The knife block will listen through a microphone connected to the RPI, and then gives the output in the form of LED buttons. For example, you would say "slice lemons", and the paring knife will be suggested. If you say "slice bagels", the bread knife will be suggested, and so on.',projectLink: 'https://github.com/Nabil-alhaffar/Knife-Station',tags: [Tag.PYTHON,],pictures: ["../../assets/knifeStation1.png", "../../assets/knifeStation2.png"]},
    ...
    { id:4, name: 'Swift periodic table iOS app ',description: 'This application reads information from a JSON file, in order to view information from the periodic table in a master-detail view.',summary:'This is a periodic table iOS application developed with Swift.',projectLink: 'https://github.com/Nabil-alhaffar/Periodic-Table-Swift-App',tags: [Tag.SWIFT],pictures: []},
