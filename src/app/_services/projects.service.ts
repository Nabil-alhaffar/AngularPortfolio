...
export class ProjectsService {
  ...
  projects: Project[] = [
    { id:0, name: 'Angular Portfolio Web Application', summary: 'This is a portfolio web application developed to showcase projects and relevant experience.',description: 'This is an angular web app built in order to show case professional background. It is built using Angular 17.3, TypeScript 5.4.2 and Node.Js 18.18 ', projectLink: 'https://github.com/Nabil-alhaffar/AngularPortfolio',tags: [Tag.ANGULAR, Tag.TYPESCRIPT,Tag.NODEJS],pictures: ["../../assets/angportfolio1.png","../../assets/angportfolio2.png", "../../assets/angportfolio3.png"]},
    ...
    { id:2,name: 'Smart Knife Station',summary: 'Novelty application developed using python and google AI speech recognition to pick the perfect type of cutlery for different kitchen applications.',description: 'This project is a knife block that uses the google speech recognition API in order to listen to commands and maps it to the best cutlery item for that particular task. The knife block will listen through a microphone connected to the RPI, and then gives the output in the form of LED buttons. For example, you would say "slice lemons", and the paring knife will be suggested. If you say "slice bagels", the bread knife will be suggested, and so on.',projectLink: 'https://github.com/Nabil-alhaffar/Knife-Station',tags: [Tag.PYTHON,],pictures: ["../../assets/knifeStation1.png", "../../assets/knifeStation2.png"]},
